...
def-env activate-virtualenv [] {
    ...
    let virtual-env = 'C:\Python310\Projects\miproyecto\mientornovirtual'
    let bin = 'Scripts'
    let path-sep = ';'
...
alias deactivate = source 'C:\Python310\Projects\miproyecto\mientornovirtual\Scripts\deactivate.nu'
